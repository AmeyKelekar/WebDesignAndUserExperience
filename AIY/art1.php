	...
	<body class="jquery-learn home page page-id-17 page-template page-template-home-php page-slug-index single-author singular">
		<?php
			...
			if($id>0)
				$mb = $id;			
		?>
		<form action="art_validate.php" method="post">
			<input type="hidden" name="mbid" value="<?php echo $mb; ?>"/>
			<div class="row">
				<div class="three columns">
					<p><label for="arttype">Type:</label>
				</div>
				<div class="nine columns">
					<input type="text" name="arttype" id="arttype" />
				</div>
			</div>
			<div class="row">
				<div class="three columns">
					<p><label for="painter">Painter:</label>
				</div>
				<div class="nine columns">
			...
			<div class="row">
				<div class="three columns">
					<p><label for="year">Year of art:</label>
				</div>
				<div class="nine columns">
			...
			<div class="row">
				<div class="three columns">
					<p><label for="artbase">Base Price:</label>
				</div>
				<div class="nine columns">
					<input type="text" name="artbase" id="artbase" />
				</div>
			</div>
			<div class="row">
				<div class="three columns">
