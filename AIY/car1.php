	...
	<body class="jquery-learn home page page-id-17 page-template page-template-home-php page-slug-index single-author singular">
		<?php
			...
			if($id>0)
				$mb = $id;
		?>
		<form action="car_validate.php" method="post">
			<input type="hidden" name="mbid" value="<?php echo $mb; ?>"/>
			<div class="row">
				<div class="three columns">
					<p><label for="carbrand">Brand:</label>
				</div>
			...
			<div class="row">
				<div class="three columns">
					<p><label for="model">Model no:</label>
				</div>
				<div class="nine columns">
			...
			<div class="row">
				<div class="three columns">
					<p><label for="carcolor">Color:</label>
				</div>
				<div class="nine columns">
			...
			<div class="row">
				<div class="three columns">
					<p><label for="carbase">Base Price::</label>
				</div>
				<div class="nine columns">
					<input type="text" name="carbase" id="carbase" />
				</div>
			</div>
			<div class="row">
				<div class="three columns">
