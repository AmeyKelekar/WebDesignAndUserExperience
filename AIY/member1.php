			...
			<nav id="main" class="constrain clearfix">
				<div class="menu-top-container">
					<ul id="menu-top" class="menu">
						<li class="menu-item"><a href="member1.php">Home</a></li>
					...
					<div id="content">
						...
						<p>
							<?php
								...
								echo "<font face='Comic Sans MS' size='+2'>Welcome</font>\n\n"; 
								echo "<font face='Comic Sans MS' size='+2' color='red'>";
								echo $uname;
								echo "</font>\n";
								echo "<font face='Comic Sans MS' size='+2'>to your seller profile page</font>";

								$query=mysql_query("SELECT * FROM users WHERE username='$uname' AND password='$pswd'");
								$type = mysql_result($query, 0, "dealer");
								$deal = mysql_result($query, 0, "dealer")."_db";
								$f=0;
								$idid = "";
								if($deal == "art_db") 
								{
								...
								$m = mysql_query("SELECT * FROM $deal WHERE mbid=0");
								$nm = mysql_num_rows($m);
								echo "<br/><br/><br/>";
								for($i=0;$i<$nm;$i++) 
								{
